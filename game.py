...
class Game:
    ...
    def handle_continuous_movement(self, direction):
        ...
        while is_run:
            ...
            for event in pygame.event.get():
                ...
                if keys[pygame.K_LEFT]:
                    ...
                    self.handle_continuous_movement("left")
                elif keys[pygame.K_RIGHT]:
                    print("goin right")
                    self.key_pressed = "right"
                    self.handle_continuous_movement("right")
                elif keys[pygame.K_DOWN]:
                    print("goin down")
                    self.key_pressed = "right"
                    self.handle_continuous_movement("down")
                else:
                    # Reset DAS when no key is pressed
                    print("das reset")
                    self.das_timer = 0
                    self.das_direction = None
